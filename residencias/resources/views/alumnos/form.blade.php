...
<p><Strong>INSTRUCCIONES: <br></Strong>
    ...
    value="{{ isset($alumno->NoCtrl)?$alumno->NoCtrl:old('NoCtrl')}}"
    > 
    ...
    <input class="form-control {{$errors->has('Nombre')?'is-invalid':'' }} " type="text" name="Nombre" id="Nombre"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
    ...
    <input class="form-control {{$errors->has('Apaterno')?'is-invalid':'' }} " type="text" name="Apaterno" id="Apaterno"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
    ...
    <input class="form-control {{$errors->has('Amaterno')?'is-invalid':'' }} " type="text" name="Amaterno" id="Amaterno"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" 
    ...
    <select name="Carrera" class="form-control {{$errors->has('NoCtrl')?'is-invalid':'' }} ">
        ...
        <OPTION VALUE="{{ isset($alumno->Carrera)?$alumno->Carrera:''}}">{{ isset($alumno->Carrera)?$alumno->Carrera:old('Carrera')}}</OPTION>
