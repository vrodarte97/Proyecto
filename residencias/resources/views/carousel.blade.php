...
<html lang="en">
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <!-- Bootstrap core CSS -->
<link href="{{ asset('assets/backoffice/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('assets/backoffice/bootstrap/css/carousel.css') }}" rel="stylesheet">
  </head>
  <body>
