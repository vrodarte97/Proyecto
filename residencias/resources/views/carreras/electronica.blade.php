...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <br>
      <div class="centered"><h1  class="display-1" style="color: #ffffff"><strong><br>Ingenieria Electrónica<strong></h1></div>
    </div>
  </header>
  <!--TERMINA MENU-->
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img src="{{ asset('assets/backoffice/img/elec1.jpg') }}" class="img-fluid" alt="Responsive image">
      </div>
    </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <br><br>
        <img src="{{ asset('assets/backoffice/img/elec2.jpg') }}" class="img-fluid" alt="Responsive image">
      </div>
