...
<body>
        ...
        <div class="container">
            ...
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff">
                    <strong><br>Ingenier&iacute;a Industrial<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p class="lead">Formar profesionistas en el campo de la ingenier&iacute;a industrial, l&iacute;deres
                creativos y emprendedores con visi&oacute;n sistem&aacute;tica, as&iacute; como, cpacidad
                anal&iacute;tica y competitiva que le permita dise&ntilde;ar, implementar, mejorar, innovar, optimizar y
                administrar sistemas de producci&oacute;n de bienes y servicios en un entorno global, cn un enfoque
                sustentable, &eacute;tico y comprometidos con la sociedad.</p>
            <br>
        </div>
    </div>
    <!--TERMINA OBJETIVO-->
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color:#1B396A;">
        <div class="container">
            ...
            <p class="lead" style="color:#e9ecef">En el sector industrial, puede administrar los sistemas de
                producci&oacute;n, de calidad de materiales, de seguridad, o en el desarrollo de nuevos proyectos y
                procesos. En las empresas de servicios es capaz de implantar y mejorar sistemas para elevar su calidad y
                productividad.<br></p>
            <p class="lead" style="color:#e9ecef">En el sector p&uacute;blico puede desarrollar u optiomizar sistemas
                para mayor efectividad y eficiencia en la prestaci&oacute;n de servicios y en la administraci&oacute;n
                de los recursos. As&iacute; mismo puede emprender su propia empresa de manufactura o de servicios.</p>
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p class="lead">Los aspirantes a estudiar el programa de ingenier&iacute;a industrial deber&aacute;n ser
                egresados del bachillerato, tener aptitudes y habilidad para las matem&aacute;ticas, f&iacute;sica,
                computaci&oacute;n y administraci&oacute;n; habilidad anal&iacute;tica y creativa para la
                soluci&oacute;n de problemas; conciencia ecol&oacute;gica, disciplina y alto sentido de responsabilidad.
                Adem&aacute;s de tener competencias comunicativas del espa&ntilde;ol.</p>
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color:#1B396A;">
        <div class="container">
            ...
            <ul class="lead" style="color:#e9ecef">
                ...
                <li>Conocer, seleccionar y aplicar tecnolog&iacute;as de automatizaci&oacute;n para optimizar procesos
                    productivos</li>
                ...
                <li>Identificar necesidades de su entorno y desarrollar investigaci&oacute;n aplicada para cear o
                    innovar bienes y/o servicios.</li>
                <li>Crear y mejorar productos de alto valor agregado bajo los principios de productivad y
                    competitividad.</li>
                <li>Participar en proyectos de transferencia, desarrollo y adaptaci&oacute;n de tecnolog&iacute;as en
                    los sistemas productivos</li>
                <li>Dise&ntilde;ar, implementar y mejorar sistemas y estaciones de trabajo considerando factores
                    ergon&oacute;micos para optimizar la producci&oacute;n. </li>
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <ul class="lead">
                    <br>
                    <li>Identificar la estructura y caracter&iacute;sticas de los modelos de excelencia m&aacute;s
                        utilizados en el sector productivo y de servicios y aplicarlos para incrementar la
                        competitividad de las organizaciones.</li>
                    <li>Conocer y aplicar normas vigentes de gesti&oacute;n de calidad para todo tipo de
                        organizaci&oacute;n.</li>
                    <li>Distinguir y analizar las formas, medios y m&eacute;todos de competitividad de una
                        organizaci&oacute;n.</li>
                    <li>Conocer y aplicar estrategias para mejorar e innovar los sistemas de una organizaci&oacute;n
                    </li>
                    <li>Manejar software b&aacute;sico para procesamiento de datos y elaboraci&oacute;n de documentos.
                    </li>
                </ul>
                <br>
            ...
            <div class="col-md-5">
                <img src="{{ asset('assets/backoffice/img/industrial1.jpg') }}" class="img-fluid"
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <br><br>
                <img src="{{ asset('assets/backoffice/img/industrial2.jpg') }}" class="img-fluid"
                    alt="Responsive image">
            </div>
