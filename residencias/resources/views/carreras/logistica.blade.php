...
<body>
        ...
        <div class="container">
            ...
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff">
                    <strong><br>Ingenier&iacute;a Logistica<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p class="lead">Formar integralmente ingenieros capaces de posicionar competitivamente en los mercados a las
                organizaciones productoras de bienes y servicios, al dise&ntilde;ar y mejorar sus procesos log&iacute;sticos a trav&eacute;s
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color:#1B396A;">
        <div class="container">
            ...
            <p class="lead" style="color:#e9ecef">El Ingeniero en Log&iacute;stica se puede desempe&ntilde;ar tanto en el sector
                privado de la industria y de servicios, como en el sector p&uacute;blico.<br></p>
            <p class="lead" style="color:#e9ecef">En la industria de manufactura de exportaci&oacute;n se puede administrar los
                sistemas de flujo de materiales; dirigir actividades de carga, tr&aacute;fico y seguridad de productos; dise&ntilde;ar
                y administrar almacenes y centros de distribuci&oacute;n; seleccionar medios de transporte de carga y
                consolidaci&oacute;n de cargas; planear la configuraci&oacute;n de la red desde el proveedor hasta el cliente;
                administrar el flujo de informaci&oacute;n y procesamiento de pedidos; realizar operaciones de importaci&oacute;n -
            ...
            <p class="lead" style="color:#e9ecef">En la industria de servicios se puede enfocar a los servicios
                log&iacute;sticos en turismo, planeaci&oacute;n de suministros para magnos eventos, administraci&oacute;n de suministros y
                espacios en centros hospitalarios.<br></p>
            <p class="lead" style="color:#e9ecef">En el sector p&uacute;blico sus actividades profesionales se enfocan en:
                planeaci&oacute;n de suministros para los procesos en obras o servicios p&uacute;blicos, administraci&oacute;n de centros de
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <ul class="lead">
                    ...
                    <li>Gestionar los procesos log&iacute;sticos en el sistema de producci&oacute;n de bienes y servicios con
                        orientaci&oacute;n de servicio al cliente.</li>
                    <li>Poseer la capacidad de an&aacute;lisis, s&iacute;ntesis y abstracci&oacute;n de la realidad.</li>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-3">
                ...
                <p class="lead"><b> *Podr&aacute;n cursarse &eacute;stos cr&eacute;ditos desde semestres anteriores</b></p>
