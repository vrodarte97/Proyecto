...
<body>
        ...
        <div class="container">
            ...
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff">
                    <strong><br>Ingenieria Mec&aacute;nica<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p class="lead">Formar profesionales en Ingenier&iacute;a Mec&aacute;nica, con aptitudes para investigar, desarrollar y
                aplicar conocimientos cient&iacute;ficos y tecnol&oacute;gicos, en las &aacute;reas de: energ&iacute;a, fluidos, dise&ntilde;o,
                manufactura, automatizaci&oacute;n, control, materiales, entre otras; mediante el empleo de las tecnolog&iacute;as de
                integraci&oacute;n de sistemas, al utilizar y administrar los recursos en forma segura, racional, eficiente,
                econ&oacute;mica y sustentable; con actitud &eacute;tica, creativa, emprendedora y de compromiso con el bienestar del
                pa&iacute;s.</p>
            <br>
        </div>
    </div>
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color:#1B396A;">
        <div class="container">
            ...
            <p class="lead" style="color:#e9ecef">El Ingeniero Mec&aacute;nico es un profesional que puede incorporarse a
                empresas que ofrezcan bienes y servicios, tanto p&uacute;blicas como privadas, por ejemplo: industrias
                extractivas, de transformaci&oacute;n, hospitales, centros de investigaci&oacute;n y educaci&oacute;n, venta de equipo,
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <p class="lead">El Ingeniero Mec&aacute;nico formula, eval&uacute;a y administra proyectos de dise&ntilde;o, manufactura,
                    instalaci&oacute;n y mantenimiento en sistemas mec&aacute;nicos; tambi&eacute;n propone sistemas integrales de gesti&oacute;n en
                    disposici&oacute;n del medio ambiente, seguridad e higiene y calidad para el dise&ntilde;o, fabricaci&oacute;n,
                    instalaci&oacute;n, control y mantenimiento de sistemas mec&aacute;nicos. Participa en proyectos tecnol&oacute;gicos y de
                    investigaci&oacute;n con el objetivo de restituir y conservar el medio ambiente que propicie un desarrollo
                    sustentable, adem&aacute;s realiza actividades de creaci&oacute;n, innovaci&oacute;n, transferencia y adaptaci&oacute;n de
