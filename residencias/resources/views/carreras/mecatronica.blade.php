...
<body>
        ...
        <div class="container">
            ...
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff">
                    <strong><br>Ingenieria Mecatr&oacute;nica<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p class="lead">Formar profesionistas en la Ingenier&iacute;a Mecatr&oacute;nica con capacidad
                anal&iacute;tica, cr&iacute;tica y creativa que le permita dise&ntilde;ar, proyectar, construir, innovar
                y administrar equipos mecatr&oacute;nicos en el sector social y productivo; as&iacute; como integrar,
                operar y mantenerlos con un compromiso &eacute;tico y de calidad en un marco de desarrollo sustentable.
            </p>
            <br>
        </div>
    </div>
    ...
    <div class="jumbotron jumbotron-fluid" style="background-color:#1B396A;">
        <div class="container">
            ...
            <p class="lead" style="color:#e9ecef">El egresado de la carrera de Ingenier&iacute;a Mecatr&oacute;nica,
                tendr&aacute; las aptitudes y destrezas para desempe&ntilde;arse entre otras, en las siguientes
                industrias: industria automotriz de ensamble y producci&oacute;n de partes, industria
                metal-mec&aacute;nica, industria qu&iacute;mica. industria petroqu&iacute;mica, industria de alimentos.
                Adem&aacute;s, en las actividades siguientes: promoci&oacute;n y activaci&oacute;n de empresas de
                servicios, Como investigador, como gestor tecnol&oacute;gico en proyectos de mecatr&oacute;nica y
                docencia.</p>
            <br>
        </div>
    </div>
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <ul class="lead">
                    <li>Ejercer su profesi&oacute;n dentro de un marco legal, teniendo un sentido de responsabilidad
                        social.</li>
                    <li>Analizar, sintetizar, dise&ntilde;ar, simular, construir e innovar productos, procesos, equipos
                        y sistemas mecatr&oacute;nicos.</li>
                    <li>Integrar, instalar, construir, optimizar, operar, controlar, mantener, administrar y/o
                        automatizar sistemas mec&aacute;nicos.</li>
