...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ url('padres') }}" type="button" class="btn btn-primary" style="background-color: #1B396A;">Inicio</a><br><br>
        ...
        <table id="table_example" class="table table-light table-hover">
            ...
            <thead>
                <tr style="background-color: #1B396A;">
                    ...
                    <th style="color:#ffffff">Nombre Alumno</th>
                    ...
                    <th style="color:#ffffff">Nombre Padre</th>
                    <th style="color:#ffffff">Apellido Paterno</th>
                    <th style="color:#ffffff">Apellido Materno</th>
