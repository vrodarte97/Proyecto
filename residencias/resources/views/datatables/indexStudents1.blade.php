...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ url('aspirantes') }}" type="button" class="btn btn-primary" style="background-color: #1B396A;"">Inicio</a><br><br>
        ...
        <table id="table_example" class="table table-light table-hover">
            ...
            <thead >
                <tr style="background-color: #1B396A;">
                    ...
                    <th style="color:#ffffff">Escuela</th>
