        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
             <li><a class="dropdown-item" href="#">Licenciatura en Administración</a></li>
             <li><a class="dropdown-item" href="#">Contador Público</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería Electromecánica</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería Mecánica</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería en Sistemas Computacionales</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería Electrónica</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería en Tecnologías de la Información y Comunicaciones</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería en Gestión Empresarial</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería Eléctrica</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería Industrial</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería en Logística</a></li>
             <li><a class="dropdown-item" href="#">Ingeniería en Mecatrónica</a></li>
              </ul>
            </li>
...
<hr>
  ...
  <div class="text-center p-3" style="background-color: #1B396A;">
    <a class="text-white" href="http://itcj.edu.mx/"><center><img src="{{ asset('assets/backoffice/img/tecnm.png') }}" alt="" width="180" height="100" class="d-inline-block align-top"></center></center></a><br>© 2021 Copyright: Instituto Tecnológico de Ciudad Juárez.</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
