...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('NombrePadre') ? 'is-invalid' : '' }} " type="text" name="NombrePadre"
        id="NombrePadre"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('ApaternoPadre') ? 'is-invalid' : '' }} " type="text" name="ApaternoPadre"
        id="ApaternoPadre"
        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('AmaternoPadre') ? 'is-invalid' : '' }} " type="text" name="AmaternoPadre"
        id="AmaternoPadrePadre"
        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('NoCtrl') ? 'is-invalid' : '' }} " type="number" name="NoCtrl" id="NoCtrl"
        min="9" value="{{ isset($padre->NoCtrl) ? $padre->NoCtrl : old('NoCtrl') }}">
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('NombreAlumno') ? 'is-invalid' : '' }} " type="text" name="NombreAlumno"
        id="NombreAlumno"
        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('ApaternoAlumno') ? 'is-invalid' : '' }} " type="text"
        name="ApaternoAlumno" id="ApaternoAlumno"
        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('AmaternoAlumno') ? 'is-invalid' : '' }} " type="text"
        name="AmaternoAlumno" id="AmaternoAlumno"
        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
...
<div class="form-group">
    ...
    <select name="Carrera" class="form-control {{ $errors->has('NoCtrl') ? 'is-invalid' : '' }} ">
        ...
        <OPTION VALUE="{{ isset($padre->Carrera) ? $padre->Carrera : '' }}">
            {{ isset($padre->Carrera) ? $padre->Carrera : old('Carrera') }}</OPTION>
