...
<head>
    ...
    <style>
        .header {
            background: url("{{ asset('assets/backoffice/img/360/admin.jpg') }}") no-repeat center;
...
<body>
    ...
    <header class="header">
                    ...
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="#">Administración/Servicios escolares</a></li>
                                <li><a class="dropdown-item" href="#">Actividades Extraescolares</a></li>
                                <li><a class="dropdown-item" href="#">Audiovisual/400s</a></li>
                                <li><a class="dropdown-item" href="#">Aulas 800s</a></li>
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Edificio
                        Administrativo<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="embed-responsive embed-responsive-21by9" style="text-align:center;">
        <iframe class="embed-responsive-item" height="500px" width="1500px"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d832.9834786933769!2d-106.42341826890696!3d31.721356183561443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86e75c0de7cc33d5%3A0xaf056c95577623f8!2sEdificio%20Administrativo%2C%20Av.%20Tecnol%C3%B3gico%201337%2C%20Olmos%20Tecnol%C3%B3gico%2C%2032510%20Cd%20Ju%C3%A1rez%2C%20Chih.!5e1!3m2!1ses-419!2smx!4v1618276716974!5m2!1ses-419!2smx"></iframe>
    </div>
