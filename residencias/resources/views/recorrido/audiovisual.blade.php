...
<head>
    ...
    <style>
        .header {
            background: url("{{ asset('assets/backoffice/img/360/400.jpg') }}") no-repeat center;
...
<body>
    ...
    <header class="header">
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Audiovisual/400<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="embed-responsive embed-responsive-21by9" style="text-align:center;">
        <iframe class="embed-responsive-item" height="500px" width="1500px"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d779.9614673117394!2d-106.42200137081143!3d31.72062949883151!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDQzJzE0LjMiTiAxMDbCsDI1JzE3LjIiVw!5e1!3m2!1ses-419!2smx!4v1618356003176!5m2!1ses-419!2smx"></iframe>
    </div>
