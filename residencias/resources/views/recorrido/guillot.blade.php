...
<head>
    ...
    <style>
        .header {
            background: url("{{ asset('assets/backoffice/img/360/guillot.jpg') }}") no-repeat center;
...
<body>
    ...
    <header class="header">
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Edificio Guillot<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="embed-responsive embed-responsive-21by9" style="text-align:center;">
        <iframe class="embed-responsive-item" height="500px" width="1500px"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d832.9994195380757!2d-106.42217506495254!3d31.71958227878983!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDQzJzExLjEiTiAxMDbCsDI1JzIxLjAiVw!5e1!3m2!1ses-419!2smx!4v1618524583696!5m2!1ses-419!2smx"></iframe>
    </div>
 <!-- Footer -->
