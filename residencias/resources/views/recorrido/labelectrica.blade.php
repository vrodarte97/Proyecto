...
<head>
    ...
    <title>Laboratorio de el&eacute;ctrica</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Laboratorio de el&eacute;ctrica<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
