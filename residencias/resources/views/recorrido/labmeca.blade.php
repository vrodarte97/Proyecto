...
<head>
    ...
    <title>Laboratorio de Mecatr&oacute;nica</title>
    ...
    <style>
        .header {
            background: url("{{ asset('assets/backoffice/img/360/manufactura.jpg') }}") no-repeat center;
...
<body>
    ...
    <header class="header">
                    ...
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="{{ url('gestion') }}">Gesti&oacute;n y vinculaci&oacute;n</a></li>
                                <li><a class="dropdown-item" href="{{ url('labelectrica') }}">Laboratorio de el&eacute;ctrica</a></li>
                                <li><a class="dropdown-item" href="{{ url('manufactura') }}">Laboratorio de Manufactura</a></li>
                                <li><a class="dropdown-item" href="{{ url('labmeca') }}">Laboratorio de Mecatr&oacute;nica</a></li>
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Laboratorio de Mecatr&oacute;nica<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="embed-responsive embed-responsive-21by9" style="text-align:center;">
        <iframe class="embed-responsive-item" height="500px" width="1500px"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d779.9834857965853!2d-106.42242987079537!3d31.71801259883154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzHCsDQzJzA0LjkiTiAxMDbCsDI1JzE4LjgiVw!5e1!3m2!1ses-419!2smx!4v1618527500616!5m2!1ses-419!2smx"></iframe>
    </div>
