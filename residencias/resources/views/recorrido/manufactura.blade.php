...
<head>
    ...
    <title>Laboratorio de Manufactura</title>
...
<body>
    ...
    <header class="header">
                    ...
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="{{ url('lmanufactura') }}">Laboratorio de Manufactura</a></li>
        ...
        <div class="container">
            <br>
            <div class="centered">
                <h1 class="display-1 animate__animated animate__fadeInLeft" style="color: #ffffff"><strong><br>Laboratorio de Manufactura<strong></h1>
            </div>
        </div>
    </header>
    <!--TERMINA MENU-->
    ...
    <div class="embed-responsive embed-responsive-21by9" style="text-align:center;">
        <iframe class="embed-responsive-item" height="500px" width="1500px"
        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d832.9848355084049!2d-106.4227903!3d31.7212052!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4784906ea5ef6e55!2sLaboratorio%20Ingenier%C3%ADa%20Industrial!5e1!3m2!1ses-419!2smx!4v1618445968971!5m2!1ses-419!2smx"></iframe>
    </div>
