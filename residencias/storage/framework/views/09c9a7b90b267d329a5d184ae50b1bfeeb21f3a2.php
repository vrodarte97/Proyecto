...
<p><Strong>INSTRUCCIONES: <br></Strong>
    ...
    <input class="form-control <?php echo e($errors->has('NoCtrl')?'is-invalid':''); ?> " type="number" name="NoCtrl" id="NoCtrl" min="9"
    value="<?php echo e(isset($alumno->NoCtrl)?$alumno->NoCtrl:old('NoCtrl')); ?>"
    > 
    ...
    <input class="form-control <?php echo e($errors->has('Nombre')?'is-invalid':''); ?> " type="text" name="Nombre" id="Nombre"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
    ...
    <input class="form-control <?php echo e($errors->has('Apaterno')?'is-invalid':''); ?> " type="text" name="Apaterno" id="Apaterno"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
    ...
    <input class="form-control <?php echo e($errors->has('Amaterno')?'is-invalid':''); ?> " type="text" name="Amaterno" id="Amaterno"  onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" 
    ...
    <div class="form-group">
    <label for="Carrera" class="control-label <?php echo e($errors->has('Carrera')?'is-invalid':''); ?> "><?php echo e('Carrera: '); ?></label>

    <select name="Carrera" class="form-control <?php echo e($errors->has('NoCtrl')?'is-invalid':''); ?> ">
                    
        <OPTION VALUE="<?php echo e(isset($alumno->Carrera)?$alumno->Carrera:''); ?>"><?php echo e(isset($alumno->Carrera)?$alumno->Carrera:old('Carrera')); ?></OPTION>
    ...
    <a class="btn btn-danger" href="<?php echo e(url('alumnos')); ?>">Cancelar</a><?php /**PATH C:\wamp64\www\resi\residencias\resources\views/alumnos/form.blade.php ENDPATH**/ ?>